...
<section class="section-two-partial-10c867">
    ...
    <div class="container">
        <div class="row align-items-end">
            <div class="col-12 col-md-7 col-lg-6 mb-5 mb-md-0 text-center">
            ...
            <div class="col-12 col-md-5 col-lg-6 text-center">
                ...
                <?php if($after_banne['reservations_ctas']): ?>
                    <ul class="reservations">
                        <?php foreach($after_banne['reservations_ctas'] as $cta): ?>
                            <li>
                                <a href="<?= $cta['cta']['url']; ?>" target="<?= $cta['cta']['target']; ?>" class="cta">
                                    ...
                                    <div class="text"><?= $cta['cta']['title']; ?></div>
                                </a>
                            </li>
                        <?php endforeach; ?>
                    </ul>
